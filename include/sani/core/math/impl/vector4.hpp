...
namespace sani {
	namespace math {
		...
		template <typename T>
		Vector4<T>::Vector4(const Vector2<T>& vector, const T& z, const T& w) 
			: x(vector.x), y(vector.y), z(z), w(w) {

		}
		template <typename T>
		Vector4<T>::Vector4(const Vector2<T>& vec1, const Vector2<T>& vec2) 
			: x(vec1.x), y(vec1.y), z(vec2.x), w(vec2.y) {

		}

		template <typename T>
		Vector4<T>::Vector4(const Vector3<T>& vector, const T& w)
		...
		template <typename T>
		const Vector4<T> Vector4<T>::operator*(const Vector4<T>& rhs) const {
		...
		// Assignments
		template <typename T>
		const Vector4<T>& Vector4<T>::operator=(const Vector4<T>& rhs) {
