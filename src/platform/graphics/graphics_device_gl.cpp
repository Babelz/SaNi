...
namespace sani {
	...
	namespace graphics {
		...
		void GraphicsDevice::drawArrays(const RenderMode mode, const uint32 first, const uint32 count) {
			CHECKED_API_CALL(glDrawArrays(static_cast<GLenum>(mode), first, count));
		}
