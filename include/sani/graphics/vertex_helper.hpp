...
namespace sani {
	...
	namespace graphics {
		...
		*/
		...
		inline void applyDefaultCircleTextureCoordinates(VertexPositionColorTexture** const vertices, const float32 rotation, const float32 radius, const math::Rectf* const textureSource, const uint32 count);
	}
}
